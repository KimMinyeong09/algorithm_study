        ...
        for y in range(1, h):
            ...
            for x in range(0, w):
                ...
                if x==0:
                    ...
                    if distTo[y-1][x-1] <= distTo[y-1][x+1]:
                        subtemp = distTo[y-1][x-1]
                        subtempi = x-1
                    else:
                        subtemp = distTo[y-1][x+1]
                        subtempi = x+1
                    if temp > subtemp:
                        temp = subtemp
                        tempi = subtempi
                distTo[y][x] = temp + self.energy(x, y)
                edgeTo[y][x] = tempi
